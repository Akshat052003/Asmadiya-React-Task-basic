...
const EmployeeForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const copy = { ...formData, resume: formData.resume?.name || null }
        const oldData = JSON.parse(localStorage.getItem("employeeData")) || []

        const updatedData = [...oldData, copy]
    ...
    const inputStyle = "p-2 rounded bg-zinc-600 text-white placeholder-gray-300 border border-transparent hover:border-blue-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200";
